...
void CRTProtocol::AddXMLElementBool(CMarkup* oXML, const _TCHAR* tTag, const bool* pbValue, const _TCHAR* tTrue, const _TCHAR* tFalse)
{
    if (pbValue)
    {
...
void CRTProtocol::AddXMLElementInt(CMarkup* oXML, const _TCHAR* tTag, const int* pnValue)
{
    if (pnValue)
    {
        CStdString tVal;
...
void CRTProtocol::AddXMLElementUnsignedInt(CMarkup* oXML, const _TCHAR* tTag, const unsigned int* pnValue)
{
    if (pnValue)
    {
        CStdString tVal;
...
void CRTProtocol::AddXMLElementFloat(CMarkup* oXML, const _TCHAR* tTag, const float* pfValue, unsigned int pnDecimals)
{
    if (pfValue)
    {
        CStdString tVal;
